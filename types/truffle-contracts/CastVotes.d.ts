...
export interface CastVotesContract extends Truffle.Contract<CastVotesInstance> {
  "new"(
    proposalNames: string[],
    meta?: Truffle.TransactionDetails
  ): Promise<CastVotesInstance>;
}

type AllEvents = never;

export interface CastVotesInstance extends Truffle.ContractInstance {
